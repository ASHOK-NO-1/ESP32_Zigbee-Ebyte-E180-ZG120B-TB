...
#define RX1_PIN 19             //zigbee pins                                                                           // Replace with the actual GPIO pin connected to E18 Zigbee RX
#define TX1_PIN 18    

#define RX2_PIN 32      //sensor pins                                                                                  // Replace with the actual GPIO pin connected to E18 Zigbee RX
#define TX2_PIN 33  
...
int RED_LED_STATE = LOW;                                                                   // the current state of button
...
void setup() {
   ...
   SerialPMS.begin(9600, SERIAL_8N1, RX2_PIN, TX2_PIN);
...
void printValues(void *pvParameters) {
  ...
  for(;;){
     if (pms.read(value)){
          ...
          Serial.println(value.PM_AE_UG_1_0);

          Serial.print("PM 2.5 (ug/m3): ");
          Serial.println(value.PM_AE_UG_2_5);

          Serial.print("PM 10.0 (ug/m3): ");
          Serial.println(value.PM_AE_UG_10_0);

          int PM_1_0_ug_per_m3= value.PM_AE_UG_1_0;
          int PM_2_5_ug_per_m3= value.PM_AE_UG_2_5;
          int PM_10_ug_per_m3= value.PM_AE_UG_10_0;
          ZIGBEE_Json_data_write(PM_1_0_ug_per_m3, PM_2_5_ug_per_m3, PM_10_ug_per_m3);
...
void ZIGBEE_Json_data_write(int PM_1_0_ug_per_m3, int PM_2_5_ug_per_m3, int PM_10_ug_per_m3 ) {
            ...
            data["pm_1_0_ug_per_m3"] = PM_1_0_ug_per_m3;
            data["pm_2_5_ug_per_m3"] = PM_2_5_ug_per_m3;
            data["pm_10_ug_per_m3"] = PM_10_ug_per_m3;           
            char output[238];
